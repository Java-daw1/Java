...
public class Main {
  public static void main(String[] args) {
    ...
    // System.out.println("estudio de tipos de datos y estructuras basicas");
    // Estudio_tipo_de_datos estudio = new Estudio_tipo_de_datos();
    // EstudioEstructurasCondicionales estudioo = new
    // EstudioEstructurasCondicionales();
    // Ejercicio01 ejercicios = new Ejercicio01();
